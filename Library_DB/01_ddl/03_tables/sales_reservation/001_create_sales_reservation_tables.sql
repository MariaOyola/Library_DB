...
CREATE TABLE sales_reservation.reservation_status (
...
CREATE TABLE sales_reservation.sale_channel (
...
CREATE TABLE sales_reservation.fare_class (
...
CREATE TABLE sales_reservation.fare (
    ...
    fare_class_id uuid NOT NULL REFERENCES sales_reservation.fare_class(fare_class_id),
...
CREATE TABLE sales_reservation.ticket_status (
...
CREATE TABLE sales_reservation.reservation (
    reservation_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    booked_by_customer_id uuid REFERENCES loyalty.customer(customer_id),
    reservation_status_id uuid NOT NULL REFERENCES sales_reservation.reservation_status(reservation_status_id),
    sale_channel_id uuid NOT NULL REFERENCES sales_reservation.sale_channel(sale_channel_id),
...
CREATE TABLE sales_reservation.reservation_passenger (
    reservation_passenger_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    reservation_id uuid NOT NULL REFERENCES sales_reservation.reservation(reservation_id),
...
CREATE TABLE sales_reservation.sale (
...
CREATE TABLE sales_reservation.ticket (
    ticket_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    sale_id uuid NOT NULL REFERENCES sales_reservation.sale(sale_id),
    reservation_passenger_id uuid NOT NULL REFERENCES sales_reservation.reservation_passenger(reservation_passenger_id),
    fare_id uuid NOT NULL REFERENCES sales_reservation.fare(fare_id),
    ticket_status_id uuid NOT NULL REFERENCES sales_reservation.ticket_status(ticket_status_id),
...
CREATE TABLE sales_reservation.ticket_segment (
    ticket_segment_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    ticket_id uuid NOT NULL REFERENCES sales_reservation.ticket(ticket_id),
    flight_segment_id uuid NOT NULL REFERENCES flight_operations.flight_segment(flight_segment_id),
...
CREATE TABLE sales_reservation.seat_assignment (
    seat_assignment_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    ticket_segment_id uuid NOT NULL REFERENCES sales_reservation.ticket_segment(ticket_segment_id),
    ...
    CONSTRAINT uq_seat_assignment_seat UNIQUE (aircraft_seat_id),
...
CREATE TABLE sales_reservation.baggage (
